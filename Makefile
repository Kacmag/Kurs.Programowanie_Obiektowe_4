...
ukladRownan: obj/main.o obj/LinearEquations.o obj/matrix.o obj/vector.o obj/LZespolona.o
	g++ -Wall -pedantic -o ukladRownan obj/main.o obj/vector.o\
                                   obj/matrix.o obj/LinearEquations.o obj/LZespolona.o

obj/main.o: src/main.cpp inc/LinearEquations.hh inc/matrix.hh inc/vector.hh inc/LZespolona.hh\
        inc/size.h
...
obj/vector.o: src/vector.cpp inc/vector.hh inc/size.h inc/LZespolona.hh
